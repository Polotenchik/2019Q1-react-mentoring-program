import {
  START_SEARCH, RESULTS_TO_STORE, OPEN_MOVIE,
  RECOMMENDED_TO_STORE, OPEN_SEARCH, CHANGE_SORTING,
} from './actionTypes';
import {
  startSearch, resultsToStore, openMovie,
  recommendedToStore, openSearch, changeItem,
} from './actions';
